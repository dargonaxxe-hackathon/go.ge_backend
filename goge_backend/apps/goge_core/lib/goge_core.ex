defmodule GoGe.Core do
  ...
  def get_outcoming_bookings(user_id), do: GoGe.Core.UseCase.GetOutcomingBookings.execute(user_id)

  def reject_booking(booking_id), do: GoGe.Core.UseCase.RejectBooking.execute(booking_id)
end
